...
import ShowPost from "../Home/Middle/ShowPost";
  ...
  return (
    <div className="box">
      <div className="pictures">
        <img
          className="big-img"
          src={`https://social-media-q3gh.onrender.com/${big_img}`}
        />
        <div className="bottom-center">
          <img
            src={
              img !== null
                ? `https://social-media-q3gh.onrender.com/${img}`
      ...
      <div className="middle">
        <div className="middle-box">
          {<ShowPost hey="123" showUserId={id} />}
        </div>
      </div>
    </div>
  );
